...
public class Reference {
	...
	public static final String DEPENDENCIES = "required-after:Forge@[10.13.4.1614,);after:Thaumcraft@[4.2.3.5,);after:TwilightForest;after:HardcoreEnderExpansion;after:bluepower;after:MineTweaker3;after:TConstruct;after:ExtraUtilities;";
